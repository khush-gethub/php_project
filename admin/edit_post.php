...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql =
        "UPDATE posts SET title = ?, description = ?, category = ?, image = ? WHERE id = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param(
        "ssssi",
        $title,
...
<form method="POST">
    ...
    <div class="form-control">
        ...
        <input type="text" name="title" class="input input-bordered" value="<?php echo $post[
            "title"
        ]; ?>" required>
    </div>
    <div class="form-control">
    ...
    <div class="form-control">
        ...
        <input type="text" name="image" class="input input-bordered" value="<?php echo $post[
            "image"
        ]; ?>">
    </div>
